...
pub fn hello_world() -> Article {
    Article::new()
        ...
        .p("Then we learned a lot from this video:")
        .youtube("https://www.youtube.com/embed/byoEBdVoVpM")
        .p("Notes:")
        .list(vec![
        ...
        .p("This video was helpful:")
        .youtube("https://www.youtube.com/embed/oyh3jYKZ0E8")
